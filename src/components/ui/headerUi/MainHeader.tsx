...
import { baseNavigationItems, NavigationItem } from "@/utils/navElements";
...
export const MainHeader: React.FC = () => {
  ...
  // Using the updated useProfile hook
  const {
    user,
    profile,
    isAuthenticated,
                  ...
                  {isAuthenticated && user ? (
                    <>
                      ...
                      <UserMenu
                        ...
                        isAdmin={
                          userContext?.permissions.isSystemAdmin ?? false
                        }
                        isSuperAdmin={userContext?.systemRole === "super_admin"}
